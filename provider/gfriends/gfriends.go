...
func (gf *GFriends) NormalizeMovieID(id string) string { return id /* AS IS */ }
...
func (gf *GFriends) ParseMovieIDFromURL(rawURL string) (string, error) {
...
func (gf *GFriends) GetActorInfoByURL(u string) (*model.ActorInfo, error) {
	id, err := gf.ParseMovieIDFromURL(u)
	if err != nil {
		return nil, err
	}
