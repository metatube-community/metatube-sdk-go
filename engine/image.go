...
import (
	...
	"github.com/javtube/javtube-sdk-go/internal/ratio"
...
func (e *Engine) GetActorPrimaryImage(id, name string) (image.Image, error) {
	...
	return e.GetImageByURL(info.Images[0], e.MustGetActorProvider(name), ratio.PrimaryImageRatio, defaultActorPrimaryImagePosition, false)
}
...
func (e *Engine) GetMoviePrimaryImage(id, name string, pos float64) (image.Image, error) {
	...
	return e.GetImageByURL(url, e.MustGetMovieProvider(name), ratio.PrimaryImageRatio, pos, auto)
}
...
func (e *Engine) GetMovieThumbImage(id, name string) (image.Image, error) {
	...
	return e.GetImageByURL(url, e.MustGetMovieProvider(name), ratio.ThumbImageRatio, defaultMovieThumbImagePosition, false)
}
...
func (e *Engine) GetMovieBackdropImage(id, name string) (image.Image, error) {
	...
	return e.GetImageByURL(url, e.MustGetMovieProvider(name), ratio.BackdropImageRatio, defaultMovieBackdropImagePosition, false)
}
